...
*/
riscv rv32pipe (clk, reset, PCF, InstrF, MemWriteM, DataAdrM, WriteDataM, ReadDataM, MemStrobeM);
...
controller c(clk, reset,
     ...
     FlushE, ZeroE, LessE, CarryoutE, PCSrcE, ALUControlE, ALUSrcAE, ALUSrcBE, ResultSrcEb0,
     MemWriteM, RegWriteM, 
     RegWriteW, ResultSrcW, MStrobeD);

datapath dp(clk, reset,
            StallF, PCF, InstrF,
        opD, funct3D, funct7b5D, StallD, FlushD, ImmSrcD,
        FlushE, ForwardAE, ForwardBE, PCSrcE, ALUControlE, ALUSrcAE, ALUSrcBE, ZeroE, LessE, CarryoutE,
...
maindec md(opD, ResultSrcD, MemWriteD, BranchD,
           ALUSrcAD, ALUSrcBD, RegWriteD, JumpD, ImmSrcD, ALUOpD, MemStobeD);
aludec  ad(opD[5], funct3D, funct7b5D, ALUOpD, ALUControlD);

// Execute stage pipeline control register and logic
floprc #(14) controlregE(clk, reset, FlushE,
                         {RegWriteD, ResultSrcD, MemWriteD, JumpD, BranchD, ALUControlD[3:0], ALUSrcAD, ALUSrcBD,MStrobeD},
                         {RegWriteE, ResultSrcE, MemWriteE, JumpE, BranchE, ALUControlE, ALUSrcAE, ALUSrcBE, MStrobeE});

//assign PCSrcE = (BranchE & ZeroE ^ funct3E[0]) | JumpE;
assign ResultSrcEb0 = ResultSrcE[0];

// Memory stage pipeline control register
flopr #(6) controlregM(clk, reset, // Updated WIDTH to 4
                       {RegWriteE, ResultSrcE, MemWriteE,MStrobeE},
                       {RegWriteM, ResultSrcM, MemWriteM,MStrobeM});
...
assign {RegWrite, ImmSrc, ALUSrcA, ALUSrcB, MemWrite,
        ResultSrc, Branch, ALUOp, Jump, MemStobe} = controls;

always_comb
  case(op)
    // RegWrite_ImmSrc_ALUSrcA_ALUSrcB_MemWrite_ResultSrc_Branch_ALUOp_Jump_Memstrobe
    7'b0000011: controls = 14'b1_000_0_1_0_01_0_00_0_1; // all loads (lw, lh, lb)
    7'b0100011: controls = 14'b0_001_0_1_1_00_0_00_0_1; // sw
    7'b0110011: controls = 14'b1_0xx_0_0_0_00_0_10_0_0; // R-type 
    7'b1100011: controls = 14'b0_010_0_0_0_00_1_01_0_0; // beq, bne
    ...
    7'b1100111: controls = 14'b1_000_0_1_0_10_0_00_0_0; // jalr
...
flopenr #(32) pcreg(clk, reset, PCReady | ~StallF, PCNextF, PCF);  //Need to work on PCReady
...
always_comb
  case(immsrc) 
    ...
    // U-type (lui/auipc)
    3'b100:  immext = {instr[31:12], 12'h0};       //ADDED
