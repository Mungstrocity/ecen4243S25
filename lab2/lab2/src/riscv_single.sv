...
string memfilename;
    //  memfilename = {"../riscvtest/test_hw2.memfile"};//riscvtest folder
     memfilename = {"../testing/bge.memfile"}; //testing folder
...
assign {RegWrite, ImmSrc, ALUSrcA, ALUSrcB, MemWrite,
  ResultSrc, Branch, ALUOp, Jump, MemStrobe} = controls; //Added Memstrobe for FPGA
...
always_comb
  case(op)
    ...
    7'b0000011: controls = 14'b1_000_0_1_0_01_0_00_0_1; // lw
    ...
    7'b0010011: controls = 14'b1_000_0_1_0_00_0_10_0_0; // I-type ALU / srai, srli, slti
    7'b1101111: controls = 14'b1_011_0_0_0_10_0_00_1_0; // jal
    7'b0110111: controls = 14'b1_100_0_1_0_11_0_00_0_0; // lui
...
always_comb
  case(ALUOp)
   ...
   3'b101: begin //right shift logic
    if(funct7b5)
...
mux3 #(32)  pcmux (PCPlus4, PCTarget, JalrTarget, PCSrc, PCNext);
// register file logic
